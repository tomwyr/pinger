...
_$_GlobalPingCounts _$$_GlobalPingCountsFromJson(Map<String, dynamic> json) =>
    _$_GlobalPingCounts(
...
Map<String, dynamic> _$$_GlobalPingCountsToJson(_$_GlobalPingCounts instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$$_PingCountToJson(_$_PingCount instance) =>
    <String, dynamic>{
      'host': instance.host,
...
Map<String, dynamic> _$$_GlobalHostResultsToJson(
...
_$_ValueResults _$$_ValueResultsFromJson(Map<String, dynamic> json) =>
    _$_ValueResults(
...
Map<String, dynamic> _$$_ValueResultsToJson(_$_ValueResults instance) =>
    <String, dynamic>{
...
_$_LocationResults _$$_LocationResultsFromJson(Map<String, dynamic> json) =>
    _$_LocationResults(
      count: json['count'] as int,
...
Map<String, dynamic> _$$_LocationResultsToJson(_$_LocationResults instance) =>
    <String, dynamic>{
      'count': instance.count,
...
_$_GlobalSessionResult _$$_GlobalSessionResultFromJson(
...
Map<String, dynamic> _$$_GlobalSessionResultToJson(
