...
mixin _$PermissionStore on PermissionStoreBase, Store {
  final _$didRejectSettingAtom = Atom(name: 'PermissionStoreBase.didRejectSetting');
  ...
  final _$canAccessServiceAtom = Atom(name: 'PermissionStoreBase.canAccessService');
  ...
  final _$_syncSettingStateAsyncAction = AsyncAction('PermissionStoreBase._syncSettingState');
  ...
  final _$_verifySettingStatusAsyncAction = AsyncAction('PermissionStoreBase._verifySettingStatus');

  @override
  Future<void> _verifySettingStatus(bool? enabled) {
    return _$_verifySettingStatusAsyncAction.run(() => super._verifySettingStatus(enabled));
  }

  final _$_checkAccessStatusAsyncAction = AsyncAction('PermissionStoreBase._checkAccessStatus');

  @override
  Future<void> _checkAccessStatus() {
    return _$_checkAccessStatusAsyncAction.run(() => super._checkAccessStatus());
  }

  final _$PermissionStoreBaseActionController = ActionController(name: 'PermissionStoreBase');
