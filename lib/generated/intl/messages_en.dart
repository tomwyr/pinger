...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "hoursSinceNow" : m1,
    "infoTrayNetworkDisabled" : MessageLookupByLibrary.simpleMessage("Device connectivity seems to be disabled. Make sure you have network access in order to be able to ping hosts"),
