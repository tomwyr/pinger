...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(days) => "${days} d";

  static String m1(hours) => "${hours} g";

  static String m2(minutes) => "${minutes} m";

  static String m3(count) => "+ ${count} więcej";

  static String m4(min, mean, max) =>
      "Min: ${min} ms / Śred: ${mean} ms / Maks: ${max} ms";

  static String m5(host) => "${host} [zakończone]";

  static String m6(current, total) => "Postęp: ${current}/${total}";

  static String m7(host) => "${host} [zatrzymane]";

  static String m8(value) => "Ostatni wynik: ${value} ms";

  static String m9(host) => "${host} [w trakcie]";

  static String m10(value) => "${value} x";

  static String m11(value) => "Twój wynik jest lepszy, niż ${value}% innych";

  static String m12(value) => "Wynik pingowania innych to ${value} ms";
  ...
  static String m17(weeks) => "${weeks} t";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "archiveEmptyDesc": MessageLookupByLibrary.simpleMessage(
            "Zapisz wyniki pingowania hosta, aby zobaczyć je później w tym miejscu"),
        ...
        "confirmHostRemoveTitle":
            MessageLookupByLibrary.simpleMessage("Usunąć zaznaczone elementy?"),
        "confirmRemoveDesc":
            MessageLookupByLibrary.simpleMessage("Tej akcji nie można cofnąć"),
        "confirmResultRemoveTitle":
            MessageLookupByLibrary.simpleMessage("Usunąć wyniki?"),
        "dataFetchFailedDesc": MessageLookupByLibrary.simpleMessage(
            "Coś poszło nie tak podczas pobierania danych - spróbuj ponownie za jakiś czas"),
        ...
        "enableLocationPromptDesc": MessageLookupByLibrary.simpleMessage(
            "Obecna pozycja zostanie dołączona do statystyk sesji, aby porównać je z innymi na mapie świata"),
        "enableLocationPromptTitle": MessageLookupByLibrary.simpleMessage(
            "Udostępnij pozycję, aby porównać swoje wyniki z innymi"),
        ...
        "infoTrayNetworkDisabled": MessageLookupByLibrary.simpleMessage(
            "Łączność urządzenia nie jest włączona. Upewnij się, że posiadasz dostęp do sieci, aby móc pingować hosty"),
        "introAdjustSettingsDesc": MessageLookupByLibrary.simpleMessage(
            "Zmień ustawienia pingowania i preferencje, aby dostosować zachowanie aplikacji"),
        "introAdjustSettingsTitle":
            MessageLookupByLibrary.simpleMessage("Dostosuj ustawienia"),
        "introPingHostDesc": MessageLookupByLibrary.simpleMessage(
            "Wykonaj szybkie pingowanie przytrzymując przycisk lub naciśnij go, aby rozpocząć nową sesję"),
        "introPingHostTitle":
            MessageLookupByLibrary.simpleMessage("Pinguj hosta"),
        "introSaveResultsDesc": MessageLookupByLibrary.simpleMessage(
            "Zapisz wyniki pingowania, aby wrócić do nich później i porównać z innymi użytkownikami"),
        "introSaveResultsTitle":
            MessageLookupByLibrary.simpleMessage("Zapisz wyniki"),
        "introSelectHostDesc": MessageLookupByLibrary.simpleMessage(
            "Wybierz hosta spośród proponowanych, znajdź go wśród hostów pingowanych przez innych lub wybierz własny"),
        "introSelectHostTitle":
            MessageLookupByLibrary.simpleMessage("Wybierz hosta"),
        "locationAccessDisabledDesc": MessageLookupByLibrary.simpleMessage(
            "Zmień ustawienia uprawnień, aby zezwolić na dostęp do lokalizacji urządzenia"),
        "locationAccessDisabledTitle":
            MessageLookupByLibrary.simpleMessage("Lokalizacja wyłączona"),
        "minutesSinceNow": m2,
        "moreHostsButtonLabel": MessageLookupByLibrary.simpleMessage("Więcej"),
        "moreHostsCountButtonLabel": m3,
        "nothingToShowTitle":
            MessageLookupByLibrary.simpleMessage("Nic jeszcze tutaj nie ma"),
        "notificationAccessDisabledDesc": MessageLookupByLibrary.simpleMessage(
            "Zmień ustawienia uprawnień, aby zezwolić na wyświetlanie powiadomień"),
        ...
        "pingCountLabel": m10,
        "pingFailedCountLabel":
            MessageLookupByLibrary.simpleMessage("Nieudane"),
        "pingGlobalByFrequencyDesc": m11,
        "pingGlobalByFrequencySubtitle":
            MessageLookupByLibrary.simpleMessage("Wyniki dla częstotliwości"),
        "pingGlobalByLocationDesc": m12,
        "pingGlobalByLocationSubtitle":
            MessageLookupByLibrary.simpleMessage("Wyniki dla lokalizacji"),
        "pingGlobalYourResult":
            MessageLookupByLibrary.simpleMessage("Twój wynik"),
        "pingInfoDateLabel": MessageLookupByLibrary.simpleMessage("Data"),
        "pingInfoDurationLabel":
            MessageLookupByLibrary.simpleMessage("Czas trwania"),
        "pingInfoInfoSubtitle":
        ...
        "pingSettingsSheetSubtitle": MessageLookupByLibrary.simpleMessage(
            "Zmiany zostaną zastosowane tylko w obecnej sesji"),
        "pingSettingsSheetTitle":
            MessageLookupByLibrary.simpleMessage("Ustawienia pingowania"),
        "pingSuccessCountLabel": MessageLookupByLibrary.simpleMessage("Udane"),
        "pingSummaryCountLabel":
            MessageLookupByLibrary.simpleMessage("Zapytania"),
        ...
        "replaceSessionSheetTitle":
            MessageLookupByLibrary.simpleMessage("Inna sesja jest uruchomiona"),
        "resetButtonLabel": MessageLookupByLibrary.simpleMessage("PRZYWRÓĆ"),
        "resultGlobalEmptyDesc": MessageLookupByLibrary.simpleMessage(
            "Sprawdź ponowanie za jakiś czas, kiedy pojawią się dane dla tego hosta"),
        "resultOtherEmptyDesc": MessageLookupByLibrary.simpleMessage(
            "Inne wyniki pojawią się w tym miejscu, kiedy zostaną zapisane dla tego hosta"),
        ...
        "resultsGlobalTabLabel":
            MessageLookupByLibrary.simpleMessage("Porównaj"),
        ...
        "searchHostHint":
            MessageLookupByLibrary.simpleMessage("Wyszukaj hosta..."),
        "searchResultsEmptyDesc": MessageLookupByLibrary.simpleMessage(
            "Brak wyników pasujących do podanego hosta - możesz nadal wybrać go i spróbować pingować"),
        "searchResultsEmptyTitle":
            MessageLookupByLibrary.simpleMessage("Nic nie znaleziono"),
        "secondsSinceNow": m16,
        "sessionAdjustButtonLabel":
            MessageLookupByLibrary.simpleMessage("Dostosuj"),
        "sessionFavoriteButtonLabel":
            MessageLookupByLibrary.simpleMessage("Ulubione"),
        "sessionPageTitle": MessageLookupByLibrary.simpleMessage("Sesja"),
        "sessionPingCountsSubtitle":
            MessageLookupByLibrary.simpleMessage("Postęp"),
        ...
        "sessionStartPromptDesc": MessageLookupByLibrary.simpleMessage(
            "Przytrzymaj przycisk, aby wysłać tyle zapytań ile potrzebujesz"),
        "sessionStartPromptTitle": MessageLookupByLibrary.simpleMessage(
            "Naciśnij przycisk, aby rozpocząć sesję"),
        "sessionSummarySubtitle":
            MessageLookupByLibrary.simpleMessage("Podsumowanie"),
        "settingSheetTitle":
            MessageLookupByLibrary.simpleMessage("Podaj nową wartość"),
        "settingsAttachLocationDesc": MessageLookupByLibrary.simpleMessage(
            "Obecna pozycja zostanie dołączona do statystyk sesji, aby porównać je z innymi na mapie świata"),
        "settingsAttachLocationTitle":
            MessageLookupByLibrary.simpleMessage("Udostępnij pozycję"),
        "settingsInfoTraySectionTitle":
            MessageLookupByLibrary.simpleMessage("Panel powiadomień"),
        "settingsNightModeTitle":
            MessageLookupByLibrary.simpleMessage("Tryb nocny"),
        ...
        "settingsRestoreHostDesc": MessageLookupByLibrary.simpleMessage(
            "Nowa sesja zostanie automatycznie utworzona dla ostatniego hosta"),
        "settingsRestoreHostTitle":
            MessageLookupByLibrary.simpleMessage("Zapamiętaj hosta"),
        "settingsResultsSectionTitle":
            MessageLookupByLibrary.simpleMessage("Wyniki"),
        "settingsShareResultsDesc": MessageLookupByLibrary.simpleMessage(
            "Statystyki sesji zostaną udostępnione, aby umożliwić innym użytkownikom porównanie ich ze swoimi wynikami"),
        "settingsShareResultsLabel":
            MessageLookupByLibrary.simpleMessage("Udostępnij wyniki"),
        "settingsSystemNotificationDesc": MessageLookupByLibrary.simpleMessage(
            "Aktualny status uruchomionej sesji pojawi się w powiadomieniach systemowych"),
        "settingsSystemNotificationTitle":
            MessageLookupByLibrary.simpleMessage("Powiadomienie systemowe"),
        "settingsTrayAutoRevealDesc": MessageLookupByLibrary.simpleMessage(
            "Panel pokaże się automatycznie, jeżeli pojawi się w nim nowy element"),
        "settingsTrayAutoRevealTitle":
            MessageLookupByLibrary.simpleMessage("Wysuń automatycznie"),
        "settingsTrayEnabledDesc": MessageLookupByLibrary.simpleMessage(
            "Informacje o stanie aplikacji będą pojawiać się w wysuwanym panelu u dołu ekranu"),
        "settingsTrayEnabledTitle":
            MessageLookupByLibrary.simpleMessage("Wyświetl panel"),
        "shareLocationButtonLabel":
            MessageLookupByLibrary.simpleMessage("Udostępnij pozycję"),
        "showIntroButtonLabel":
            MessageLookupByLibrary.simpleMessage("Wprowadzenie"),
